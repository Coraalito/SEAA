...
<div class=" ml-2 mr-2 p-3  rounded" style="background-color: rgb(255, 255, 255)">
  <h4 class="text-center font-weight-bold">Solicitudes de eventos</h4>
</div>
@stop
                    ...
                    <div class="col-12">                  
                        <div class="table-responsive">
                          <table class="table table-striped ">
                              <head>
                                <tr>
                                  <th>Unidad de Multimedia</th>
                                  <th>Unidad de comunicación y radio</th>
                                  <th>Coordinación de extenciones</th>
                                  <th>Coordinación de servicios generales</th>
                                  <th>CTA</th>
                                </tr>
                              </head>
                              <tbody>
